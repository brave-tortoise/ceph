...
// promotion params
OPTION(osd_promote_candidate_queue_max_size, OPT_INT, 128)
OPTION(osd_promote_work_queue_max_size, OPT_INT, 64)
...
OPTION(osd_pool_default_cache_target_warm_ratio, OPT_FLOAT, .6)
